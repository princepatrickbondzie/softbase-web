...
export default function Hero() {
  ...
  return (
    ...
    <header>
        ...
        <div className=" container md:w-full sm:w-full w-full bg-center bg-cover h-[32rem]" style={{backgroundImage:"url(https://images.unsplash.com/photo-1504384308090-c894fdcc538d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80)"}}>
